...
public:
	...
	virtual void IncrementMinionCount_Implementation(const int32 Count) override;
...
protected:
	...
	UPROPERTY(VisibleAnywhere)
	TObjectPtr<UPassiveNiagaraComponent> ProtectionNiagaraComponent;
