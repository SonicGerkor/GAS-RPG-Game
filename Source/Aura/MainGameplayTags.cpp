...
void FMainGameplayTags::InitializeNativeGameplayTags()
{
	...
	GameplayTags.Abilities_Fire_MeteorShower = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Abilities.Fire.MeteorShower"), FString("MeteorShower Ability Tag."));
